...
- `index.html` — struktur halaman dan semua modal popup
- `style.css` — tampilan dan tema
- `script.js` — logika utama aplikasi
- `data/builds.json` — data build bawaan yang dimuat pertama kali
- `js/manual-add.js` — form untuk tambah build secara manual
- `js/schematic-import.js` — parser file schematic
...
Aplikasi ini pakai `fetch()` untuk load file JSON, jadi tidak bisa dibuka langsung dengan double-click. Harus pakai server lokal dulu.
